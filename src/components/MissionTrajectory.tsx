...
const milestones = [
  { year: '2022', title: 'Founding', description: 'Afferent Technologies begins its voyage into the tech universe.' },
  { year: '2023', title: 'Expansion', description: 'Launched comprehensive internship programs in 5 major domains.' },
  { year: '2024', title: 'Innovation', description: 'Pioneered AI & Robotics solutions for industrial applications.' },
